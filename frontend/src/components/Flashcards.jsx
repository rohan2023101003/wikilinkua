...
import { CognateBadge, PhoneticBadge, BridgeBadge, SoundIcon } from './Badges';
  ...
  return (
    ...
    >
      ...
      <div>
        {!reveal ? (
          /* Card Front - Centered */
          <div style={{ width: '100%', border: '1px solid #c8ccd1', borderRadius: '2px', padding: '36px 24px', textAlign: 'center', background: '#f8f9fa', boxSizing: 'border-box' }}>
          ...
          /* Card Back - Centered */
          <div style={{ width: '100%', border: '1px solid #c8ccd1', borderRadius: '2px', padding: '36px 24px', background: '#f8f9fa', textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', boxSizing: 'border-box' }}>
        ...
        {!reveal ? (
          <>
            <button 
              ...
              style={{ flex: 1, padding: '14px', borderRadius: '2px', background: '#ffffff', color: '#3366cc', border: '1.5px solid #3366cc', fontWeight: '700', fontSize: '15px', textAlign: 'center', cursor: 'pointer' }}
            >
              Show meaning
            </button>
            <button 
              onClick={() => onAnswer(true)}
              style={{ flex: 1, padding: '14px', borderRadius: '2px', background: '#3366cc', color: '#ffffff', border: '1px solid #3366cc', fontWeight: '700', fontSize: '15px', textAlign: 'center', cursor: 'pointer' }}
            >
              I knew it
            </button>
          </>
  ...
  if (!quizQueue.length) {
    return (
      <div className="cdx-card" style={{ padding: '32px', textAlign: 'center', margin: '40px auto', maxWidth: '650px', border: '1px solid #c8ccd1', borderRadius: '2px', background: '#ffffff' }}>
        ...
        <p style={{ margin: '16px 0 24px', color: '#54595d', fontSize: '14px' }}>We couldn't find any bridge words with meanings to quiz you on.</p>
    ...
    return (
      <div className="cdx-card" style={{ maxWidth: '550px', margin: '40px auto', padding: '32px', textAlign: 'center', border: '1px solid #c8ccd1', borderRadius: '2px', background: '#ffffff' }}>
        ...
        <div style={{ display: 'flex', gap: '12px', justifyContent: 'center' }}>
          <button onClick={handleRestart} className="cdx-button" style={{ padding: '12px 24px', borderRadius: '2px', background: '#3366cc', color: '#fff', border: '1px solid #3366cc', fontWeight: '600', cursor: 'pointer' }}>Play Again</button>
          <button onClick={() => onNavigate('game-modes')} className="cdx-button" style={{ padding: '12px 24px', borderRadius: '2px', cursor: 'pointer', border: '1px solid #c8ccd1', background: '#fff', color: '#202122' }}>Back to Games</button>
        </div>
      </div>
    );
  }
  ...
  return (
    <div style={{ margin: '20px auto', maxWidth: '650px' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px', color: '#54595d' }}>
        ...
        <span style={{ fontWeight: '600', fontSize: '0.95rem' }}>Card {currentIndex + 1} of {quizQueue.length}</span>
      </div>
